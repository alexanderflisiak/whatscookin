...
// ⚡ Bolt: Wrapped in React.memo() to pair with useDeferredValue in RecipeGrid.
// This prevents expensive re-renders of all unchanged cards when typing in the search bar.
