...
// ⚡ Bolt: Memoize RecipeCard so it doesn't re-render when RecipeGrid re-renders (due to search input updates or other state changes).
// This is essential for useDeferredValue in RecipeGrid to actually work and prevent typing lag.
