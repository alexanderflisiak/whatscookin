...
// ⚡ Bolt: Wrapped in React.memo to prevent unnecessary re-renders when parent RecipeGrid
// updates its search state (which re-renders synchronously despite useDeferredValue).
// Expected impact: ~O(N) fewer DOM render cycles during typing where N is the number of visible cards.
