...
// ⚡ Bolt: Wrapped in React.memo to prevent re-renders when RecipeGrid's immediate search state updates.
// This is required to realize the performance benefits of useDeferredValue in the parent.
