...
// ⚡ Bolt: Memoize RecipeCard to prevent unnecessary re-renders when RecipeGrid's search state updates.
// This must be paired with useDeferredValue in RecipeGrid to actually defer rendering of the list.
