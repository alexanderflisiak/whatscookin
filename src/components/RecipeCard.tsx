...
// ⚡ Bolt: Wrapped in React.memo to prevent re-rendering all cards when RecipeGrid's search input updates
// (which triggers state changes despite useDeferredValue)
