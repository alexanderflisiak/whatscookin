...
// ⚡ Bolt: Memoize RecipeCard to prevent unnecessary re-renders when parent lists update.
// Impact: Eliminates O(N) re-renders during fuzzy search or typing in RecipeGrid.
