...
// ⚡ Bolt: Memoize the RecipeCard to prevent re-renders when the parent RecipeGrid's
// original state updates due to search typing (since RecipeGrid uses useDeferredValue).
