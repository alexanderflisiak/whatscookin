    ...
    <div className="fixed inset-0 z-100 bg-background flex flex-col pt-safe px-4 pb-safe animate-in slide-in-from-bottom flex-1 overflow-hidden">
      ...
      <div className="grid grid-cols-2 gap-4 pb-6 mt-auto shrink-0">
        <button 
          ...
          className="h-20 bg-stone-200 rounded-md flex items-center justify-center disabled:opacity-30 disabled:pointer-events-none hover:bg-stone-300 active:scale-95 transition-all text-stone-600 touch-none focus-visible:ring-2 focus-visible:ring-stone-400 focus-visible:outline-none"
        >
        ...
        {isDone ? (
          ...
          <button 
            ...
            className="h-20 bg-primary text-white border border-border hover:bg-stone-800 rounded-md flex items-center justify-center active:scale-95 transition-all shadow-sm touch-none focus-visible:ring-2 focus-visible:ring-stone-400 focus-visible:outline-none"
          >
