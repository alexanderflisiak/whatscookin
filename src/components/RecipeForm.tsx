        ...
        <div role="group" aria-labelledby="ingredients-heading">
          <div className="block text-sm font-semibold mb-1 flex justify-between items-center">
            ...
            <button 
              ...
              className="text-text-hi text-sm flex items-center gap-1 font-medium bg-stone-50 px-2 py-1 rounded focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-stone-400"
            >
            ...
            {fields.map((field, index) => (
              <div key={field.id} className="flex gap-2 items-start">
                ...
                <button 
                  ...
                  className="p-2 text-text-lo hover:text-danger hover:bg-red-50 rounded-lg transition-colors mt-0.5 shrink-0 focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-danger"
                >
