        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-3 bg-white border border-border rounded-md outline-none focus-visible:ring-2 focus-visible:ring-stone-300 transition-shadow text-text-hi placeholder:text-text-lo"
            />
          </div>
          <button 
            ...
            className="shrink-0 w-12 h-12 bg-white border border-border rounded-md flex items-center justify-center text-text-hi hover:bg-stone-50 outline-none focus-visible:ring-2 focus-visible:ring-stone-300 transition-colors shadow-sm"
          >
          ...
          <button 
            ...
            title="I'm Lazy Mode"
            aria-label="Toggle I'm Lazy Mode for quick and easy recipes"
            aria-pressed={isLazyFilter}
            className={`shrink-0 w-12 h-12 border border-border rounded-md flex items-center justify-center outline-none focus-visible:ring-2 focus-visible:ring-stone-300 transition-colors shadow-sm ${
